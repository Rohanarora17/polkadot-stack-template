...
type IStorage = {
    ...
    Proxy: {
         ...
         */
        Proxies: StorageDescriptor<[Key: SS58String], Anonymize<I1808sk45co89c>, false, never>;
        /**
...
type ICalls = {
    ...
    Proxy: {
         ...
         * zero.
         */
        add_proxy: TxDescriptor<Anonymize<I80cht592rotce>>;
        /**
         ...
         */
        remove_proxy: TxDescriptor<Anonymize<I80cht592rotce>>;
        /**
         ...
         */
        create_pure: TxDescriptor<Anonymize<Ibpc4kthjktuo>>;
        /**
         ...
         */
        kill_pure: TxDescriptor<Anonymize<I1i6grf28bv9hm>>;
        /**
    ...
    AhMigrator: {
         ...
         */
        receive_proxy_proxies: TxDescriptor<Anonymize<I1sdjtg0mom46u>>;
        /**
...
type IEvent = {
    ...
    Proxy: {
         ...
         */
        PureKilled: PlainDescriptor<Anonymize<I1n8ob4k6240vs>>;
        /**
         ...
         * A proxy was added.
         */
        ProxyAdded: PlainDescriptor<Anonymize<I6m4engkf1gbh2>>;
        /**
         * A proxy was removed.
         */
        ProxyRemoved: PlainDescriptor<Anonymize<I6m4engkf1gbh2>>;
        /**
...
type IRuntimeCalls = {
    ...
    BlockBuilder: {
         ...
         * this block or not.
         */
        apply_extrinsic: RuntimeDescriptor<[extrinsic: Binary], Anonymize<I4ip92cejsh8vu>>;
        /**
    ...
    ReviveApi: {
         ...
         */
        call: RuntimeDescriptor<[origin: SS58String, dest: FixedSizeBinary<20>, value: bigint, gas_limit: Anonymize<Iasb8k6ash5mjn>, storage_deposit_limit: Anonymize<I35p85j063s0il>, input_data: Binary], Anonymize<Iel648dq935909>>;
        /**
         * Instantiate a new contract.
         *
         * See `[crate::Pallet::bare_instantiate]`.
         */
        instantiate: RuntimeDescriptor<[origin: SS58String, value: bigint, gas_limit: Anonymize<Iasb8k6ash5mjn>, storage_deposit_limit: Anonymize<I35p85j063s0il>, code: Anonymize<I9sijb8gfrns29>, data: Binary, salt: Anonymize<I4s6vifaf8k998>], Anonymize<I284b23t92u5po>>;
        /**
         ...
         */
        upload_code: RuntimeDescriptor<[origin: SS58String, code: Binary, storage_deposit_limit: Anonymize<I35p85j063s0il>], Anonymize<Id20o5u3itehte>>;
        /**
         ...
         */
        get_storage: RuntimeDescriptor<[address: FixedSizeBinary<20>, key: FixedSizeBinary<32>], Anonymize<Ieogbgh0dt6bkn>>;
        /**
         ...
         * doesn't exist, or doesn't have a contract then `Err` is returned.
         */
        get_storage_var_key: RuntimeDescriptor<[address: FixedSizeBinary<20>, key: Binary], Anonymize<Ieogbgh0dt6bkn>>;
        /**
...
export type Paseo_hubDispatchError = Anonymize<I72ju98lulovhp>;
type IAsset = PlainDescriptor<Anonymize<If9iqq7i64mur8>>;
export type Paseo_hubExtensions = {};
type PalletsTypedef = {
    __storage: IStorage;
    __tx: ICalls;
    __event: IEvent;
...
export type Paseo_hub = {
    ...
    asset: IAsset;
    extensions: Paseo_hubExtensions;
    getMetadata: () => Promise<Uint8Array>;
    genesis: string | undefined;
};
declare const _allDescriptors: Paseo_hub;
export default _allDescriptors;
export type Paseo_hubApis = ApisFromDef<IRuntimeCalls>;
export type Paseo_hubQueries = QueryFromPalletsDef<PalletsTypedef>;
export type Paseo_hubCalls = TxFromPalletsDef<PalletsTypedef>;
export type Paseo_hubEvents = EventsFromPalletsDef<PalletsTypedef>;
export type Paseo_hubErrors = ErrorsFromPalletsDef<PalletsTypedef>;
export type Paseo_hubConstants = ConstFromPalletsDef<PalletsTypedef>;
export type Paseo_hubViewFns = ViewFnsFromPalletsDef<PalletsTypedef>;
export type Paseo_hubCallData = Anonymize<I7ghpul17sf1lm> & {
    value: {
        type: string;
    };
};
