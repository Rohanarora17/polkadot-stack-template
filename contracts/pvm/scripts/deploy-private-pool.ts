...
async function main() {
	console.log("Deploying StealthPay private pool stack (PVM/resolc)...");
	...
	updateDeployments({
		stealthPayPoolPvm: poolReceipt.contractAddress,
		withdrawVerifierPvm: verifierReceipt.contractAddress,
	});
